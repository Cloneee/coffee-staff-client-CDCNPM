...
export const ListEmployeePage = () => {
  ...
  const confirmDelete = async () =>{
    try {
      if (selectedEmployee?.EmployeeId) await employeeAPi.remove(selectedEmployee.EmployeeId);
      Toast(
        'success',
  ...
  const onFormSubmitDetailModal = async (employee: Employee) => {
    try {
      if (employee.EmployeeId) await EmployeeAPi.update(employee.EmployeeId, employee);
      Toast(
        'success',
